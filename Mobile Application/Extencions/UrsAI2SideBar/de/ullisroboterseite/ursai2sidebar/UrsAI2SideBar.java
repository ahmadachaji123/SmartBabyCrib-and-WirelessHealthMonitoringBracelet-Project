...
// 
// Version 1.6 (2024-09-03)
// -------------------------
// - Kategorien für einige Properties hinzugefügt.
// - Mit der neuen Version des AI2-SDK übersetzt
...
@DesignerComponent(version = 1, //
        ...
        dateBuilt = UrsAI2SideBar.dateBuilt, //
...
public class UrsAI2SideBar extends AndroidNonvisibleComponent implements OnOrientationChangeListener {
    ...
    static final String dateBuilt = "2024-09-03";
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Returns true if the SideBar is active and clickable.")
    public boolean Enabled() {
        return sideBar.getEnabled();
    }

    @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_TEXTAREA, defaultValue = "")
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Set the list from a string of comma-separated values.")
    public void ItemsFromString(String itemstring) {
        sideBar.setItems(ElementsUtil.elementsFromString(itemstring));
    }

    @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_ASSET, defaultValue = "")
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Loads the items from a file.", userVisible = false)
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the top image asset file name.")
    public String Image() {
        return sideBar.getImageName();
    }

    @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN, defaultValue = "True")
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Specifies wether the top image is scaled to the SideBar's width.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the size of the siwpe detector field.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the width of the sidebar as a percentage of the display width.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Specifies the alignment of the title image: left, center, right).")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the SideBars's deafult text color as an alpha-red-green-blue integer.")
    @IsColor
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the SideBars's text color as an alpha-red-green-blue integer.")
    @IsColor
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the SideBars's icon color as an alpha-red-green-blue integer.")
    @IsColor
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the SideBars's background color as an alpha-red-green-blue integer.")
    @IsColor
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the default font size.")
    public float FontSize() {
        return sideBar.getFontSize();
    }

    @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN, defaultValue = "False")
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Specifies wether the SideBar displays Switches instead of CheckBoxes.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the padding of the icon to the left border.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the distance between the icon and the text.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the Switch's thumb color when switch is in the On state.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Gets the Switch's thumb color when switch is in the Off state.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Color of the toggle track when switched on.")
    ...
    @SimpleProperty(category = PropertyCategory.APPEARANCE, description = "Color of the toggle track when switched off.")
