...
public class SideBar {
   ...
   public void show(boolean byCommand, boolean raiseEvent) {
      ...
      // Der äußere Rahmen. Oben ist der imageViewContainer zur Aufname des Bildes.
      // Darunter listView zur Aufnahme der Items.
      LinearLayout listViewContainer = null;

      // Zur Aufnahme des Titelbildes.
      ...
      // Zeigt die Itemliste an und wird listViewAdapter beschickt.
      listView = new ListView(form);

      listViewAdapter = new ListViewAdapter(form, listViewItemDefs, this, barWidth);
